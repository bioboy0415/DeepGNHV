...
do
    ...
    do  
        ...
        params="CUDA_VISIBLE_DEVICES=${GPU_Id} python -u ${DeepGNHV_Dir}/DeepGNHV_main.py
                ...
                --Eval_Output_Dir           ${DeepGNHV_Dir}/output/VF${VF}_humanvirus_Crossvalidation
                --Eval_Positive_Catalog     ${DeepGNHV_Dir}/data/pair_data/VF${VF}/VirusAppear_VF${VF}_C${j}Virus_positive_list.txt
                --Eval_Negative_Catalog     ${DeepGNHV_Dir}/data/pair_data/VF${VF}/VirusAppear_VF${VF}_C${j}Virus_negative_list.txt
                ...
                --Eval_Savefile_Name        Highest_Model_Teston_C${j}Virus
